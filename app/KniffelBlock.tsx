  ...
  return (
    <div className="mx-auto w-full sm:p-12 p-4">
      ...
      */}
      ...
      <div className="overflow-auto overscroll-none snap-x snap-mandatory scroll-pl-[130px] sm:scroll-pl-[160px] max-h-[calc(100dvh-100px)] sm:max-h-screen w-full rounded-4xl border-2 border-red-600 bg-white shadow-sm">
